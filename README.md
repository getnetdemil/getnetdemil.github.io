...
<p align="center"> 
    <a href="https://getnetdemil.github.io" target="_blank">
...
To view a live example, **[click here](https://getnetdemil.github.io/)**
...
- After the successful installation of `nodejs` and `npm`, clone the repository into your local system using below command:
  ```bash
   git clone https://github.com/getnetdemil/masterPortfolio.git
  ```
